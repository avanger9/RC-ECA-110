...
trainingfilenames = {'images':'./train-images-idx3-ubyte',
					 'labels':'./train-labels-idx1-ubyte'}
testfilenames = {'images':'./t10k-images-idx3-ubyte',
...
#print(train_images_array[10000][15][17])

# variables principals amb les imatges:
# train_images_array
# train_images_array
# test_labels_array
# test_images_array
...
np.save('train_labels_array.npy',train_labels_array)
np.save('train_images_array.npy',train_images_array)
np.save('test_labels_array.npy',test_labels_array)
np.save('test_images_array.npy',test_images_array)

trla = np.load('./train_labels_array.npy')
tria = np.load('./train_images_array.npy')
tela = np.load('./test_labels_array.npy')
teia = np.load('./test_images_array.npy')
